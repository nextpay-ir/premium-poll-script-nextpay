...
<section>
  <div class="container">
     ...
     <div class="row flat">
<div class="col-md-12"><div class="alert alert-info">لطفا برای استفاده از امکانات ویژه، ابتدا در سایت ثبت نام کنید. سپس ایمیل بزنید تا اکانت شما را به حالت پرمیوم ارتقا دهیم.</div></div>
<style>
.alert-info {
	...
	font-size: 20px;
        ...
        <div class="col-md-4">
            <ul class="plan plan1">
                <li class="plan-name"><?php echo e("Starter") ?></li><li class="plan-price"><strong><?php echo e("Free") ?></strong> <?php echo e("Forever") ?></li>
